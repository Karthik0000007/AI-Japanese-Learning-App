...
# Load whisper once
whisper_model = whisper.load_model("base")  # or "tiny" if GPU RAM limited
...
def translate():
    ...
    try:
        ...
        if re.search(r'[\u3040-\u30ff\u4e00-\u9faf]', phrase):  # Japanese characters
...
def batch_translate():
    try:
        ...
        for text in texts:
            try:
                # Reuse the single translation endpoint logic
